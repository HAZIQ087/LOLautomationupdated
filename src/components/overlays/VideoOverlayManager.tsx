...
import { FloatingPatchOverlay } from "./FloatingPatchOverlay";
...
export const VideoOverlayManager = ({ matchData, onOverlayComplete, isRecording = false, patchVersion = "15.15" }: VideoOverlayManagerProps) => {
  ...
  return (
    <div className="video-overlay-container relative">
      {/* Floating Patch Overlay - Always visible during recording */}
      <FloatingPatchOverlay
